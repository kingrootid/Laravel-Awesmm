            ...
            <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#general" role="tab">
                        <span class="d-block d-sm-none"><i class="fas fa-adjust me-2"></i></span>
                        <span class="d-none d-sm-block"><i class="fas fa-adjust me-2"></i> Umum</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#favorite" role="tab">
                        <span class="d-block d-sm-none"><i class="far fa-star me-2"></i></span>
                        <span class="d-none d-sm-block"><i class="far fa-star me-2"></i> Favorit</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#search" role="tab">
                        <span class="d-block d-sm-none"><i class="fas fa-search me-2"></i></span>
                        <span class="d-none d-sm-block"><i class="fas fa-search me-2"></i> Cari ID</span>
                    </a>
                </li>
            </ul>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content text-muted">
                        ...
                        <div class="tab-pane" id="favorite" role="tabpanel">
                            <div class="form-group mb-3">
                                <label>Kategori <span class="text-danger">*</span></label>
                                <select class="form-select" name="category" id="favorite_category">
                            ...
                            <div class="form-group mb-3">
                                <label>Layanan <span class="text-danger">*</span></label>
                                <select class="form-select" id="favorite_service">
                                    <option value="null">-- Tidak Ada Layanan --</option>
                                </select>
                            </div>
                        </div>
